...
public class TipoDadoPrincipal {
	...
	public static void main(String[] args) {
		 ...
		 * idade = 45; 
		 * sexo = 'M'; 
		 * salario = 1000.00f; // f no final para informar que é um float invés de um double 
		...
		//salario = Float.parseFloat(JOptionPane.showInputDialog("Qual o seu salário?"));
		
		//salarioAnual = Double.parseDouble(JOptionPane.showInputDialog("Qual o seu salário anual? "));
		...
		System.out.println(formatador1.format(date1)); // aqui ele mostra formatado com x formatação
