...
public class RevisaoProva 
{
	public static void main(String[] args) 
	{
		...
		for (int i = 0; i < quantidadeAlunos; i++) {
			...
			System.out.println("Média: " + formatador.format(mediaAluno));
		...
		System.out.println("Melhor média: " + formatador.format(melhorMediaGeral));
		System.out.println("Pior média: " + formatador.format(piorMediaGeral));
		teclado.close();
	}
}
