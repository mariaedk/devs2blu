...
public class RefatoracaoMain 
{
	...
	{	
		...
		// criei um objeto anonimo do tipo carroDAO e chamei o método atribuiinformacoesCarro
		// esse método retorna um carro. Logo estou colocando um objeto do tipo carro dentro de outro do tipo carro
